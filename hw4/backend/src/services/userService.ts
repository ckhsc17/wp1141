  ...
  async getUserTreasures(
    ...
    try {
      ...
      const treasureDTOs: TreasureDTO[] = treasures.map(treasure => ({
        ...
        tags: treasure.tags,
        isPublic: treasure.isPublic ?? undefined,
        isHidden: treasure.isHidden ?? undefined,
    ...
    try {
      ...
      const treasureDTOs: TreasureDTO[] = favorites
        ...
        .map(favorite => ({
          ...
          isPublic: favorite.treasure.isPublic ?? undefined,
          isHidden: favorite.treasure.isHidden ?? undefined,
